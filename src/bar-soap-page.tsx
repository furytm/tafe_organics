...
export default function BarSoapPageContent() {
  ...
  return (
    <main>
      {/* PROMO BANNER */}
      <div className=" bg-[#6BBE49] text-center py-3 text-sm font-semibold playfairreg text-gray-800">
      ...
      <div className="py-12 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-8 gap-4 animate-fadeIn">
            <div>
              <h1 className="text-4xl md:text-5xl playfairbold font-bold mb-2 animate-slideDown">Soaps</h1>
              <p className="text-gray-600 animate-slideUp">Showing all {soaps.length} results</p>
            </div>
