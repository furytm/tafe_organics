...
import AboutBrandSection from "@/src/components/about-brand-section"
...
export default function HomeContent() {
  ...
  const slides = [
    ...
    {
      image: "/images/shea-cocoa-balm.jpg",
    ...
    <main>
      ...
      <section className="relative w-full h-[40vh] md:h-[75vh] lg:h-screen overflow-hidden flex items-center">
        ...
        {slides.map((slide, index) => (
          ...
          >
            <img src={slide.image || "/placeholder.svg"} className="w-full h-full object-cover" alt="Hero slide" />
      ...
      <section className="py-20 px-4 bg-white -mt-8 md:-mt-16 relative z-10">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl playfairbold font-bold text-center mb-12 md:mb-16 tracking-widest">
            SHOP BY CATEGORY
          </h2>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center px-4">
            ...
            <p className="mt-4 text-xs sm:text-sm text-gray-600">Free Standard Shipping on Orders Over ₦100k</p>
          </div>
        </div>
      </section>
       {/* TESTIMONIALS SECTION */}
      <TestimonialsSection backgroundImage="/images/neemoil.jpg"/>
